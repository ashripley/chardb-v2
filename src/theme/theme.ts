...
export interface Types extends BaseTheme {
  normal: string;
  fire: string;
  water: string;
  grass: string;
...
interface Status extends BaseTheme {
  error: 'rgb(226 54 54)';
  success: 'rgb(130 221 85)';
  info: 'rgb(74 144 226)';
}

interface Bg extends BaseTheme {
  bgGray0: string;
  bgGray15: string;
  bgGray25: string;
  bgGray50: string;
...
interface Fonts extends BaseTheme {
  primary: string;
}

interface Accents extends BaseTheme {
  char: string;
  bulb: string;
  squir: string;
}

interface Icons extends BaseTheme {
